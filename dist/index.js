...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst serif_1 = __webpack_require__(/*! ../text/serif */ \"./src/text/serif.ts\");\nvar NpcId;\n(function (NpcId) {\n    NpcId[NpcId[\"first\"] = 0] = \"first\";\n    NpcId[NpcId[\"last\"] = 999] = \"last\";\n})(NpcId = exports.NpcId || (exports.NpcId = {}));\nvar NpcType;\n(function (NpcType) {\n    NpcType[NpcType[\"normal\"] = 0] = \"normal\";\n})(NpcType = exports.NpcType || (exports.NpcType = {}));\nexports.NpcList = [\n    {\n        id: NpcId.first,\n        type: NpcType.normal,\n        name: \"うにくん\",\n        serif: [\n            serif_1.Serif.first1,\n            serif_1.Serif.first2,\n            serif_1.Serif.first3,\n            serif_1.Serif.first4,\n            serif_1.Serif.first5,\n        ],\n    },\n    //最後\n    {\n        id: NpcId.last,\n        type: NpcType.normal,\n        name: \"うにくん\",\n        serif: [\n            serif_1.Serif.last1,\n            serif_1.Serif.last2,\n            serif_1.Serif.last3,\n            serif_1.Serif.last4,\n            serif_1.Serif.last5,\n            serif_1.Serif.last6,\n            serif_1.Serif.last6,\n            serif_1.Serif.last6,\n            serif_1.Serif.last6,\n            serif_1.Serif.last6,\n            serif_1.Serif.last6,\n            serif_1.Serif.last6,\n            serif_1.Serif.last6,\n            serif_1.Serif.last7,\n        ],\n    },\n];\n\n\n//# sourceURL=webpack:///./src/config/npc.ts?");
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst State_1 = __webpack_require__(/*! ../State */ \"./src/State.ts\");\nconst config_1 = __webpack_require__(/*! ../config */ \"./src/config.ts\");\nconst EnemyList_1 = __webpack_require__(/*! ../enemy/EnemyList */ \"./src/enemy/EnemyList.ts\");\nconst slimeImg = new Image();\nslimeImg.src = \"./src/image/character/slime.png\";\nconst foxImg = new Image();\nfoxImg.src = \"./src/image/character/fox.png\";\nconst tvImg = new Image();\ntvImg.src = \"./src/image/character/tv.png\";\nconst underlegImg = new Image();\nunderlegImg.src = \"./src/image/character/underleg.png\";\nconst hayasainuImg = new Image();\nhayasainuImg.src = \"./src/image/character/hayasainu.png\";\nconst zawatsukiImg = new Image();\nzawatsukiImg.src = \"./src/image/character/zawatuki.png\";\nconst prismImg = new Image();\nprismImg.src = \"./src/image/character/prism.png\";\nexports.default = (con, drawStartPoint) => {\n    if (State_1.S.Frag.another) {\n        let another_tyle = \"./src/image/mojibake.png\";\n        slimeImg.src = another_tyle;\n        foxImg.src = another_tyle;\n        tvImg.src = another_tyle;\n        underlegImg.src = another_tyle;\n        hayasainuImg.src = another_tyle;\n        zawatsukiImg.src = another_tyle;\n        prismImg.src = another_tyle;\n    }\n    con.textBaseline = \"middle\";\n    con.textAlign = \"center\";\n    const enemys = State_1.S.enemys;\n    for (let i = 0; i < enemys.length; i++) {\n        if (enemys[i].point.x >= drawStartPoint.x &&\n            enemys[i].point.x < drawStartPoint.x + config_1.DrawRange.x &&\n            enemys[i].point.y >= drawStartPoint.y &&\n            drawStartPoint.y + config_1.DrawRange.y) {\n            drawEnemy(con, enemys[i], drawStartPoint);\n        }\n    }\n};\nfunction drawEnemy(con, enemy, drawStartPoint) {\n    const id = enemy.id;\n    if (id === EnemyList_1.EnemyId.slime) {\n        drawEnemyImg.slime(con, enemy.point, drawStartPoint);\n    }\n    else if (id === EnemyList_1.EnemyId.fox) {\n        drawEnemyImg.fox(con, enemy.point, drawStartPoint);\n    }\n    else if (id === EnemyList_1.EnemyId.tv) {\n        drawEnemyImg.tv(con, enemy.point, drawStartPoint);\n    }\n    else if (id === EnemyList_1.EnemyId.underleg) {\n        drawEnemyImg.underleg(con, enemy.point, drawStartPoint);\n    }\n    else if (id === EnemyList_1.EnemyId.hayasainu) {\n        drawEnemyImg.hayasainu(con, enemy.point, drawStartPoint);\n    }\n    else if (id === EnemyList_1.EnemyId.zawatsuki) {\n        drawEnemyImg.zawatsuki(con, enemy.point, drawStartPoint);\n    }\n    else if (id === EnemyList_1.EnemyId.prism) {\n        drawEnemyImg.prism(con, enemy.point, drawStartPoint);\n    }\n}\nvar drawEnemyImg;\n(function (drawEnemyImg) {\n    function slime(con, popPoint, drawStartPoint) {\n        const ratio = 1;\n        const size_x = config_1.TyleSize.x * ratio;\n        const size_y = config_1.TyleSize.y * ratio;\n        const fix = (config_1.TyleSize.x * (1 - ratio)) / 2;\n        con.drawImage(slimeImg, 0, 0, 64, 64, (popPoint.x - drawStartPoint.x) * config_1.TyleSize.x + fix, (popPoint.y - drawStartPoint.y) * config_1.TyleSize.y + fix, size_x, size_y);\n    }\n    drawEnemyImg.slime = slime;\n    function fox(con, popPoint, drawStartPoint) {\n        const ratio = 1;\n        const size_x = config_1.TyleSize.x * ratio;\n        const size_y = config_1.TyleSize.y * ratio;\n        const fix = (config_1.TyleSize.x * (1 - ratio)) / 2;\n        con.drawImage(foxImg, 0, 0, 64, 64, (popPoint.x - drawStartPoint.x) * config_1.TyleSize.x + fix, (popPoint.y - drawStartPoint.y) * config_1.TyleSize.y + fix, size_x, size_y);\n    }\n    drawEnemyImg.fox = fox;\n    function tv(con, popPoint, drawStartPoint) {\n        const ratio = 1;\n        const size_x = config_1.TyleSize.x * ratio;\n        const size_y = config_1.TyleSize.y * ratio;\n        const fix = (config_1.TyleSize.x * (1 - ratio)) / 2;\n        con.drawImage(tvImg, 0, 0, 64, 64, (popPoint.x - drawStartPoint.x) * config_1.TyleSize.x + fix, (popPoint.y - drawStartPoint.y) * config_1.TyleSize.y + fix, size_x, size_y);\n    }\n    drawEnemyImg.tv = tv;\n    function underleg(con, popPoint, drawStartPoint) {\n        const ratio = 1;\n        const size_x = config_1.TyleSize.x * ratio;\n        const size_y = config_1.TyleSize.y * ratio;\n        const fix = (config_1.TyleSize.x * (1 - ratio)) / 2;\n        con.drawImage(underlegImg, 0, 0, 64, 64, (popPoint.x - drawStartPoint.x) * config_1.TyleSize.x + fix, (popPoint.y - drawStartPoint.y) * config_1.TyleSize.y + fix, size_x, size_y);\n    }\n    drawEnemyImg.underleg = underleg;\n    function hayasainu(con, popPoint, drawStartPoint) {\n        const ratio = 1;\n        const size_x = config_1.TyleSize.x * ratio;\n        const size_y = config_1.TyleSize.y * ratio;\n        const fix = (config_1.TyleSize.x * (1 - ratio)) / 2;\n        con.drawImage(hayasainuImg, 0, 0, 64, 64, (popPoint.x - drawStartPoint.x) * config_1.TyleSize.x + fix, (popPoint.y - drawStartPoint.y) * config_1.TyleSize.y + fix, size_x, size_y);\n    }\n    drawEnemyImg.hayasainu = hayasainu;\n    function zawatsuki(con, popPoint, drawStartPoint) {\n        const ratio = 1;\n        const size_x = config_1.TyleSize.x * ratio;\n        const size_y = config_1.TyleSize.y * ratio;\n        const fix = (config_1.TyleSize.x * (1 - ratio)) / 2;\n        con.drawImage(zawatsukiImg, 0, 0, 64, 64, (popPoint.x - drawStartPoint.x) * config_1.TyleSize.x + fix, (popPoint.y - drawStartPoint.y) * config_1.TyleSize.y + fix, size_x, size_y);\n    }\n    drawEnemyImg.zawatsuki = zawatsuki;\n    function prism(con, popPoint, drawStartPoint) {\n        const ratio = 1;\n        const size_x = config_1.TyleSize.x * ratio;\n        const size_y = config_1.TyleSize.y * ratio;\n        const fix = (config_1.TyleSize.x * (1 - ratio)) / 2;\n        con.drawImage(prismImg, 0, 0, 64, 64, (popPoint.x - drawStartPoint.x) * config_1.TyleSize.x + fix, (popPoint.y - drawStartPoint.y) * config_1.TyleSize.y + fix, size_x, size_y);\n    }\n    drawEnemyImg.prism = prism;\n})(drawEnemyImg = exports.drawEnemyImg || (exports.drawEnemyImg = {}));\n\n\n//# sourceURL=webpack:///./src/draw/drawEnemys.ts?");
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst config_1 = __webpack_require__(/*! ../config */ \"./src/config.ts\");\nconst npc_1 = __webpack_require__(/*! ../config/npc */ \"./src/config/npc.ts\");\nexports.default = (S, con, drawStartPoint) => {\n    con.textBaseline = \"middle\";\n    con.textAlign = \"center\";\n    let npcs = S.npcs;\n    for (let i = 0; i < npcs.length; i++) {\n        let npc = npcs[i];\n        if (npc.point.x >= drawStartPoint.x &&\n            npc.point.x < drawStartPoint.x + config_1.DrawRange.x &&\n            npc.point.y >= drawStartPoint.y &&\n            npc.point.y < drawStartPoint.y + config_1.DrawRange.y) {\n            drawNpc(con, npc, drawStartPoint);\n        }\n    }\n};\nlet npcImg = new Image();\nnpcImg.src = \"./src/image/character/uni.png\";\nfunction drawNpc(con, npc, drawStartPoint) {\n    const type = npc.type;\n    if (type === npc_1.NpcType.normal) {\n        const ratio = 1;\n        const size_x = config_1.TyleSize.x * ratio;\n        const size_y = config_1.TyleSize.y * ratio;\n        const fix = (config_1.TyleSize.x * (1 - ratio)) / 2;\n        const point = npc.point;\n        con.drawImage(npcImg, 0, 0, 64, 64, (point.x - drawStartPoint.x) * config_1.TyleSize.x + fix, (point.y - drawStartPoint.y) * config_1.TyleSize.y + fix, size_x, size_y);\n    }\n}\n\n\n//# sourceURL=webpack:///./src/draw/drawNpcs.ts?");
...
/***/ "./src/floor/floorModel/lastFloor.ts":
/*!*******************************************!*\
  !*** ./src/floor/floorModel/lastFloor.ts ***!
  \*******************************************/
/*! no static exports found */
...
"use strict";
eval("\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst Room_1 = __importDefault(__webpack_require__(/*! ../Room */ \"./src/floor/Room.ts\"));\nconst Floor_1 = __webpack_require__(/*! ../Floor */ \"./src/floor/Floor.ts\");\nconst fillUpWall_1 = __importDefault(__webpack_require__(/*! ../usecase/fillUpWall */ \"./src/floor/usecase/fillUpWall.ts\"));\nconst digRooms_1 = __importDefault(__webpack_require__(/*! ../usecase/digRooms */ \"./src/floor/usecase/digRooms.ts\"));\nconst putDownstair_1 = __importDefault(__webpack_require__(/*! ../usecase/putDownstair */ \"./src/floor/usecase/putDownstair.ts\"));\n/* 一階の設計図 */\nconst point = { x: 1, y: 1 };\nconst size = { width: 13, height: 13 };\nconst rooms = [new Room_1.default(point, size, 1)];\nconst downstair = { x: 7, y: 2 };\nconst gates = [];\nconst floorSize = { width: 15, height: 15 };\nconst lastFloor = new Floor_1.Floor(floorSize, rooms, gates, downstair);\nexports.lastFloor = lastFloor;\nlastFloor.blocks = fillUpWall_1.default(lastFloor, lastFloor.blocks);\nlastFloor.blocks = digRooms_1.default(lastFloor, lastFloor.blocks);\nlastFloor.blocks = putDownstair_1.default(lastFloor);\n\n\n//# sourceURL=webpack:///./src/floor/floorModel/lastFloor.ts?");
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst config_1 = __webpack_require__(/*! ../config */ \"./src/config.ts\");\nvar Serif;\n(function (Serif) {\n    /* 最初のフロア */\n    Serif.first1 = {\n        text: \"降りるとダンジョン始まるよ\",\n        type: config_1.MessageType.normal,\n    };\n    Serif.first2 = {\n        text: \"頑張ってね\",\n        type: config_1.MessageType.normal,\n    };\n    Serif.first3 = {\n        text: \"降りないとはじまらないよ\",\n        type: config_1.MessageType.normal,\n    };\n    Serif.first4 = {\n        text: \"はやくいきな\",\n        type: config_1.MessageType.normal,\n    };\n    Serif.first5 = {\n        text: \"・・・\",\n        type: config_1.MessageType.normal,\n    };\n    Serif.first1_a = {\n        text: \"きみがこわした\",\n        type: config_1.MessageType.danger,\n    };\n    /* クリアフロア */\n    Serif.last1 = {\n        text: \"おめでとう、クリアです！\",\n        type: config_1.MessageType.normal,\n    };\n    Serif.last2 = {\n        text: \"よくがんばりました\",\n        type: config_1.MessageType.normal,\n    };\n    Serif.last3 = {\n        text: \"クリアしたのに後ろに階段があるって？\",\n        type: config_1.MessageType.normal,\n    };\n    Serif.last4 = {\n        text: \"この先には何もないよ\",\n        type: config_1.MessageType.normal,\n    };\n    Serif.last5 = {\n        text: \"だからいかないほうがいい\",\n        type: config_1.MessageType.normal,\n    };\n    Serif.last6 = {\n        text: \"いかないほうがいい\",\n        type: config_1.MessageType.normal,\n    };\n    Serif.last7 = {\n        text: \"縺?°縺ｪ縺?⊇縺?′縺?\",\n        type: config_1.MessageType.danger,\n    };\n})(Serif = exports.Serif || (exports.Serif = {}));\n\n\n//# sourceURL=webpack:///./src/text/serif.ts?");
