...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst Enemy_1 = __webpack_require__(/*! ./Enemy */ \"./src/enemy/Enemy.ts\");\nexports.EnemyOnFloor = [\n    [],\n    [Enemy_1.EnemyId.slime, Enemy_1.EnemyId.fox],\n    [Enemy_1.EnemyId.slime, Enemy_1.EnemyId.fox],\n    [Enemy_1.EnemyId.tv, Enemy_1.EnemyId.fox],\n    [Enemy_1.EnemyId.underleg, Enemy_1.EnemyId.fox],\n    [Enemy_1.EnemyId.underleg, Enemy_1.EnemyId.fox],\n    [Enemy_1.EnemyId.underleg, Enemy_1.EnemyId.fox, Enemy_1.EnemyId.hayasainu],\n    [Enemy_1.EnemyId.tv, Enemy_1.EnemyId.fox, Enemy_1.EnemyId.hayasainu],\n    [Enemy_1.EnemyId.hayasainu, Enemy_1.EnemyId.zawatsuki],\n];\nexports.EnemyList = [\n    {\n        id: Enemy_1.EnemyId.slime,\n        name: \"でっぱり\",\n        level: 1,\n        HP: 5,\n        ATK: 1,\n        DEF: 1,\n        EXP: 1,\n    },\n    {\n        id: Enemy_1.EnemyId.fox,\n        name: \"置きぎつね\",\n        level: 1,\n        HP: 7,\n        ATK: 2,\n        DEF: 2,\n        EXP: 3,\n    },\n    { id: Enemy_1.EnemyId.tv, name: \"はこ\", level: 3, HP: 13, ATK: 4, DEF: 4, EXP: 9 },\n    {\n        id: Enemy_1.EnemyId.underleg,\n        name: \"またした\",\n        level: 3,\n        HP: 15,\n        ATK: 5,\n        DEF: 4,\n        EXP: 11,\n    },\n    {\n        id: Enemy_1.EnemyId.hayasainu,\n        name: \"スピード犬\",\n        level: 4,\n        HP: 17,\n        ATK: 6,\n        DEF: 3,\n        EXP: 13,\n    },\n    {\n        id: Enemy_1.EnemyId.zawatsuki,\n        name: \"ざわつき\",\n        level: 6,\n        HP: 26,\n        ATK: 7,\n        DEF: 5,\n        EXP: 32,\n    },\n];\n\n\n//# sourceURL=webpack:///./src/enemy/EnemyList.ts?");
